...
public partial class MainWindow : Window
{
    ...
    private void ExecutorTest_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var testWindow = new ExecutorTestWindow();
            testWindow.Show();
        }
        catch (Exception ex)
        {
            MessageBox.Show($"Failed to open Executor Test: {ex.Message}", "Error",
                MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
